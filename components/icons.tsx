...
export const RemoveBgIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 6.75h4.5M9.75 12h4.5m-4.5 5.25h4.5m-6.75 2.25h13.5a2.25 2.25 0 0 0 2.25-2.25V6.75a2.25 2.25 0 0 0-2.25-2.25H7.5A2.25 2.25 0 0 0 5.25 6.75v10.5a2.25 2.25 0 0 0 2.25 2.25z" strokeDasharray="2 2"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 6.313A2.25 2.25 0 0 0 10.5 4.5h-3A2.25 2.25 0 0 0 5.25 6.75v10.5A2.25 2.25 0 0 0 7.5 19.5h3A2.25 2.25 0 0 0 12.75 17.25V6.313z" />
    </svg>
);

export const AutoEnhanceIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
